...
There are four main user roles in the application:
- **Admin**: Manages the platform and users
- **Child**: Primary user, interacts with activities and modules
- **Parent**: Monitors child progress and interacts with features
- **Teacher**: Provides educational content and monitors students

Teachers and parents are both considered users, with access to their respective dashboards and features.
